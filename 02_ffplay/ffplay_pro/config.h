...
#define FFMPEG_CONFIGURATION "--pkg-config-flags=--static --extra-cflags=-I/home/lqf/ffmpeg_build/include --extra-ldflags=-L/home/lqf/ffmpeg_build/lib --extra-libs='-lpthread -lm' --disable-yasm --enable-gpl --enable-libfdk-aac --enable-libmp3lame --enable-libtheora --enable-libvorbis --enable-libx264 --enable-nonfree --disable-optimizations --enable-debug --enable-shared --enable-static --disable-stripping --enable-pic"
